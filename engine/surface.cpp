...
/*static*/ TextureType Surface::QueryFormat( const char* formatString )
{
	...
	else if ( grinliz::StrEqual( "RGBA32", formatString ) ) {
		return TEX_RGBA32;
	}
	else if ( grinliz::StrEqual( "RGB24", formatString ) ) {
		return TEX_RGB24;
	}
	GLASSERT( 0 );
	return TEX_RGB16;
...
void Surface::ScaleByHalf()
{
	...
	for( int y=0; y<halfH; ++y ) {
		for( int x=0; x<halfW; ++x ) {
			...
			Color4U8 c = {  U8((c00.r()+c01.r()+c10.r()+c11.r())>>2),
							U8((c00.g()+c01.g()+c10.g()+c11.g())>>2),
							U8((c00.b()+c01.b()+c10.b()+c11.b())>>2),
							U8((c00.a()+c01.a()+c10.a()+c11.a())>>2) };
