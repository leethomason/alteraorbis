...
{
	static Chit* checkRecursion = nullptr;
	Chit* oldRecurse = checkRecursion;
	GLASSERT(checkRecursion != this);		// don't call setPosition in setPosition!
	checkRecursion = this;
