...
IString IStringConst::sparkExplosion;
IString IStringConst::sparkPowerUp;
...
void IStringConst::Init()
{
	...
	electron = StringPool::Intern( "electron", true );
	...
	sparkExplosion = StringPool::Intern( "sparkExplosion", true );
	sparkPowerUp = StringPool::Intern( "sparkPowerUp", true );
