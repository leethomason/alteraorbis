...
IString IStringConst::Kaxa;
IString IStringConst::Vyllis;
IString IStringConst::Rava;
IString IStringConst::Oggar;
...
void IStringConst::Init()
{
	...
	visitor = StringPool::Intern( "visitor", true );
	...
	Kaxa = StringPool::Intern( "Kaxa", true );
	Vyllis = StringPool::Intern( "Vyllis", true );
	Rava = StringPool::Intern( "Rava", true );
	Oggar = StringPool::Intern( "Oggar", true );
